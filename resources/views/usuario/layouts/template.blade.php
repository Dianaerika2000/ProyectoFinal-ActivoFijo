...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootswatch@4.5.2/dist/css/bootstrap.min.css"
        title="main">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('usuario.usuarios') }}">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('usuario.inmueble') }}">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('usuario.fotografia') }}">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('usuario.formulas') }}">
                    <i class="fas fa-book"></i>
                    <span>Gestionar Adquisiciones</span></a>
            </li>
            ...
            {{-- <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.reportes') }}">
                    ...
                    <span>Gestionar Reportes</span></a>
            </li> --}}
            <!-- Nav Item - Charts -->
            {{-- <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.reportes') }}">
                    <i class="fas fa-chart-line"></i>
                    <span>Gestionar Producción</span></a>
            </li> --}}
            {{-- ....................................................................................... --}}
            {{-- codigo para realizar busqueda rapida --}
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow" onmouseover="ver(1)" onmouseout="ocultar(1)">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small">{{ auth()->user()->u_nombre }}
                                    {{ auth()->user()->u_app }}</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" id="div1"
                                ...
                                <a class="dropdown-item" href="{{ route('usuario.usuarios') }}">
                                ...
                                <form action="{{ route('usuario.logout') }}" method="POST"
                                    onclick="return alertCerrarSesion();">
                                    {{ csrf_field() }}
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">
                            @yield('header') {{-- para poder mostrarlo en el index.php --}}
                        </h1>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto ">
                        <span>Copyright &copy; ACTIVO FIJO - INMUEBLE 2022</span>
                        <div class="version">
                        </div>
                    </div>
                </div>
    ...
    {{-- este script es usado por todos los form de las vistas para confirmar eliminacion de registros --}}
    <script>
    ...
    {{-- para agregar un pedaso de codigo en la plantilla template uso lo siguinte: --}}
    {{-- @yield('js') --}}
    <script>

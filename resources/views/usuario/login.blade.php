...
<head>
    ...
    <title>Iniciar session como Usuario </title>

    <!-- Custom fonts for this template-->
    <link href="{{asset('UsuarioTemplate/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-imageg">
                                <img src="{{asset('UsuarioTemplate/img/logo.png')}}">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Bienvenido usuario</h1>
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    @endif
                                    <form class="user" action="{{ route('usuario.login')}}" method="POST">
                                        {{ csrf_field() }}

        ...
        <div class="row">
            ...
            <div hidden class="col-lg-9 form-input">
                <div class="card">
                    <div class="card-body">
                        <div>
                            <form class="user" action="{{ route('usuario.inventario.parametrizarformula') }}" method="GET">
                                {{ csrf_field() }}
            ...
            <div hidden class="col-lg-9 form-input2">
                <div class="card">
                    <div class="card-body">
                        <div>
                            <form class="user" action="{{ route('usuario.inventario.parametrizarfecha') }}" method="GET">
                                {{ csrf_field() }}
                                <div class="form-group">
            ...
            <div hidden class="col-lg-9 form-input3">
                <div class="card">
                    <div class="card-body">
                        <div>
                            <form class="user" action="{{ route('usuario.inventario.parametrizarestado') }}" method="GET">
                                {{ csrf_field() }}
                                <div class="form-group">

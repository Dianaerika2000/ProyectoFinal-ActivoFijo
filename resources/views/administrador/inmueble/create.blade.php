    ...
    <div class="container pt-5">
        ...
        <div class="card o-hnameden border-0 shadow-lg">
            <div class="card-header py-3">
                <h4 class="m-0">Registrar Nuevo Inmueble</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
                        <div class="p-5">
                            ...
                            @endif
                            <form class="needs-validation" novalidate action="{{ route('admin.inmueble.store') }}"
                                method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 ">
                                        <select name="idGrupo" class="form-control" id="idGrupo" required>
                                    ...
                                    <div class="col-md-12 col-sm-12 ">
                                        <select name="idInmueble" class="form-control" id="idInmueble">
                                            ...
                                            @foreach ($inmuebles as $inmueble)
                                                <option value="{{ $inmueble->id }}"> <b>PREFIJO:
                                                        {{ \Illuminate\Support\Str::limit($inmueble->codigo, 5, '') }}</b>
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"
                                        for="descripcionGlosa">Descripción
                                    </label>
                                    <div class="col-md-12 col-sm-12 ">
                                        <input type="textarea" id="descripcionGlosa" name="descripcionGlosa"
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="fechaAdquisicion">Fecha
                                        de Adquisición
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <div class="invalid-feedback">
                                            El campo Fecha
                                            de Adquisición es obligatorio.
                                        </div>
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="monto">Monto
                                        (Bs)<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <select name="idResponsable" class="form-control" id="idResponsable" required>
                                            ...
                                            @foreach ($responsables as $responsable)
                                                <option value="{{ $responsable->id }}">{{ $responsable->nombre }}
                                                    {{ $responsable->Apellido }} - {{ $responsable->codigoAsignado }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="map-canvas"
                                        id="label0">Registrar Dirección
                                        <span class="required">*</span>
                                    </label>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-sm-11 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value="{{ old('descripcion') }}" type="textarea"
                                                    class="form-control input-sm" name="descripcion" id="descripcion"
